...
Notice!!! if the dice total is 2 or 7, you recieve a 10 mon bonus!
''')
...
while True:  # Main game loop.
    ...
    if playerWon:
        ...
        house_fee = int(pot * 0.12)  # The house takes 12%, calculation was converted into an interget to avoid rounding errors.
